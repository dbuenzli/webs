...
module Http : sig
  ...
  (** [base64] and [base64url] codecs.
      ...
      non-canonical encodings} to ensure that no two different
      encodings decode to the same byte sequence (see
  ...
  module Base64 : sig
    ...
    (** [decode] is like {!decode'} with errors mapped
        by {!error_message}[ `Base64]. *)
